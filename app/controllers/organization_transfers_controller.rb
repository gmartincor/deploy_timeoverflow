# Controller para manejar transferencias directas entre bancos de tiempo aliados
class OrganizationTransfersController < ApplicationController
  ...
  def create
    ...
    # Las transferencias entre bancos no tienen post asociado
    @transfer.post = nil

    # Utilizamos el mecanismo estándar de persistencia de transferencias
